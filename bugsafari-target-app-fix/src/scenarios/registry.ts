...
export const SCENARIOS: Scenario[] = [
  ...
  {
    slug: 'input-fuzzing',
    title: 'Input Sanitization / Boundary Stress',
    category: 'Security',
    bugClass: 'INPUT_SANITIZATION_FAILURE',
    cwe: 'CWE-20',
    expectedSeverity: 'HIGH',
    detector: 'DataFuzzer strategies',
    summary: 'Boundary and malformed payloads in typed inputs destabilize the backend into a 5xx.',
    reproduction: 'Submit an out-of-range number or malformed JSON; POST /api/compute throws 500.',
    detected: true,
