...
const featureCards = [
    {
        ...
        title: 'Tests Itself',
        description:
            'Point BugSafari at your app and it explores on its own — clicking buttons, filling forms, and following links like a real user. No test scripts to write, ever.',
    },
    {
        icon: Brain,
        title: 'Learns As It Goes',
        description:
            'It figures out which parts of your app are most likely to break — logins, payments, deletes — and spends its time where real bugs hide.',
    },
    {
        icon: ClipboardCheck,
        title: 'Shows What Broke',
        description:
            'Every bug comes with clear, step-by-step instructions to reproduce it, so you know exactly what to fix and how.',
    },
];

const howItWorks = [
    { icon: Link2, title: 'Add Your App', description: 'Paste in the web address of the app you want to test.' },
    { icon: Play, title: 'Press Start', description: 'One click and BugSafari begins exploring. Pause or resume anytime.' },
    { icon: Eye, title: 'Watch It Explore', description: 'See every click, form, and result stream in live as it happens.' },
...
const HomeSection = memo(function HomeSection({ onLogin }: { onLogin: () => void }) {
    return (
        <>
            {/* Hero Section */}
            <section className="relative overflow-hidden px-6 py-12 bg-[#f4f4f5]">
                <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="relative z-10 min-w-0 space-y-6">
                        ...
                        <p className="text-[16px] leading-[24px] text-zinc-600 max-w-lg">
                            BugSafari explores your web app on its own — clicking, typing, and stress-testing it like a real user — then hands you a clear report of everything that broke and how to reproduce it. No test scripts to write.
                        </p>
                    ...
                    <div className="relative min-w-0">
                        <div className="relative bg-[#f4f4f5] border border-zinc-200/80 rounded-xl overflow-hidden shadow-2xl shadow-zinc-200/50">
            ...
            {/* Trust indicators */}
            <section className="px-6 pb-8 bg-[#f4f4f5]">
                <div className="max-w-[1440px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-px bg-zinc-200 border border-zinc-200 rounded-xl overflow-hidden">
                    {trustStats.map((stat) => (
                        <div key={stat.label} className="bg-[#f4f4f5] p-6 text-center space-y-1">
            ...
            {/* Feature Highlights */}
            <section className="py-24 px-6 bg-[#f4f4f5]">
                <div className="max-w-[1440px] mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {featureCards.map((card) => (
                            <div key={card.title} className="p-8 border border-zinc-200/80 rounded-xl bg-[#f4f4f5] shadow-md shadow-zinc-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group cursor-default flex flex-col justify-between">
                                <div>
                                    <div className="w-12 h-12 bg-[#121212] text-white rounded-lg flex items-center justify-center mb-6 shrink-0">
            ...
            {/* How It Works */}
            <section className="py-24 px-6 bg-zinc-50/50 border-y border-zinc-200">
                <div className="max-w-[1440px] mx-auto space-y-16">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-[16px] text-zinc-600 max-w-2xl mx-auto">No setup, no scripts. Get real results in the time it takes to grab a coffee.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {howItWorks.map((item) => (
                            <div key={item.title} className="p-6 bg-[#f4f4f5] border border-zinc-200 rounded-xl space-y-3 shadow-xs">
            ...
            <section className="py-24 px-6 bg-[#f4f4f5]">
                <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="p-2 border border-zinc-200/80 rounded-2xl bg-[#f4f4f5] shadow-xl shadow-zinc-200/50">
            ...
            <section className="py-24 px-6 bg-zinc-50/50 border-y border-zinc-200">
                <div className="max-w-[1440px] mx-auto space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {testimonials.map((t) => (
                            <div key={t.quote} className="p-8 bg-[#f4f4f5] border border-zinc-200 rounded-xl shadow-sm flex flex-col justify-between space-y-6">
            ...
            {/* Final CTA */}
            <section className="py-32 px-6 text-center bg-zinc-50/50 border-t border-zinc-200">
                <div className="max-w-3xl mx-auto space-y-8">
                    <h2 className="text-[48px] text-black font-extrabold uppercase">Ready To Catch More Bugs?</h2>
                    <p className="text-[16px] text-zinc-600">Point BugSafari at your app and watch it work. It's free to try — no signup, no scripts, no setup.</p>
...
const LandingPage = () => {
    ...
    return (
        <div className="bg-[#f4f4f5] text-black min-h-screen font-sans selection:bg-[#121212] selection:text-white">
            ...
            {/* Footer */}
            <footer className="bg-[#f4f4f5] border-t border-zinc-200">
