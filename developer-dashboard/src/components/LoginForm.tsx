      ...
      <div className="w-full max-w-[400px]">
        <div className="bg-white border border-[#DBEAFE] rounded-[12px] shadow-md px-8 py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="username" className="block text-[12px] font-medium text-[#434655] mb-2">Username</label>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="block text-[12px] font-medium text-[#434655]">Password</label>
