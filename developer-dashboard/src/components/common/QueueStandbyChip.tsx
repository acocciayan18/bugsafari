...
export default function QueueStandbyChip() {
    ...
    return (
        <span
            className="flex min-w-0 items-center gap-2 rounded-lg bg-(--status-neutral-bg) text-(--status-neutral-fg) px-3 py-2 text-xs font-bold uppercase  sm:px-4 sm:text-[13px] sm:r"
            aria-live="polite"
        >
