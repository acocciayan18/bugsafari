...
const CWE_CATALOG: Record<string, CweInfo> = {
  ...
  'CWE-209': { name: 'Sensitive Information in an Error Message', plain: 'An error sent to the browser leaks internal detail such as a stack trace or a raw database error.' },
