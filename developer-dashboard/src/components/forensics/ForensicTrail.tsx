        ...
        <article className="rounded-lg border border-(--status-critical-border) bg-(--status-critical-bg) p-3">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="mt-1 text-xs text-(--text-secondary)">URL: {latest.url}</div>
            </div>
          </div>

<div className="mt-3">
            <div className="text-xs font-semibold text-(--text-primary)">Reproduction Playbook</div>
            <ol className="mt-2 list-decimal space-y-2 pl-5 text-xs text-(--text-secondary)">
          ...
          {latest.stackTrace ? (
            <details className="mt-3">
              <summary className="cursor-pointer text-xs font-semibold text-(--text-primary)">Stack Trace</summary>
