...
export default function App() {
  ...
  const createGateway = useCallback(() => new SocketHttpEngineGateway(API_BASE_URL, SOCKET_URL), []);

  const { state, startTest, pauseTest, resumeTest, stopTest } = useDashboardController(createGateway);
    ...
    <main className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section className="mt-4 grid grid-cols-1 items-start gap-6 lg:grid-cols-3">
          ...
          <div className="grid min-h-[420px] grid-rows-[1fr_1fr] gap-6">
