...
const CATS = ['electronics', 'apparel', 'home', 'books'];
const SORTS = [
  { key: '', label: 'Featured' },
    ...
    <div className="shop">
      ...
      <section className="results">
        ...
        {loading ? (
          ...
          <div className="empty"><h2>Something went wrong</h2><p className="muted">We couldn't load products. Please try again.</p></div>
        ) : !products.length ? (
          <div className="empty"><h2>No products found</h2><p className="muted">Try a different search or category.</p></div>
        ) : (
